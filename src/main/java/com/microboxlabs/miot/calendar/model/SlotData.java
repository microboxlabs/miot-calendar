...
public record SlotData(
    ...
    @Schema(required = true, description = "Minutes of the slot (0-59)", minimum = "0", maximum = "59", examples = {"0"})
    Integer minutes
) {
    /**
     * Validate slot data
    ...
    public void validate() {
        ...
        if (minutes == null || minutes < 0 || minutes > 59) {
            throw new IllegalArgumentException("Slot minutes must be between 0 and 59");
        }
    }
}
